...
def plot_graphs(numbers_of_nodes=[100], edge_probabilities=[0.1],
    ...
    smooth_end=False, forbidden_values=[], fdict={}, pdict={}, lcc_method_main = "pmult", savefig='', simbool = True, executable_path = r"C:\Users\jj\Downloads\GitHub\small-perc\libs\p-recursion.exe", executable2 = r"C:\Users\jj\Downloads\GitHub\small-perc\max-degree.exe"):
                ...
                for i_ep, p in enumerate(edge_probabilities):
                    ...
                    if performance=='relative LCC':
                        ...
                        finiteRelS = finiteTheory.relSCurve(p,n,
                            attack=attack, fdict=fdict,pdict=pdict,lcc_method_relS=lcc_method_main,executable_path=executable_path, executable2=executable2)
                        print(finiteRelS)
