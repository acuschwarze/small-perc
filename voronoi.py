...
# initial data retreival for making voronoi diagrams

# type of removal: "random" or "targeted"
removal = "random" 
if removal == "random":
...
# some formatting from csv file: have to add 1 to each index for the n,p,mse
...
# add data to initialized arrays
nw = []
nwnodes = []
nwprobs=[]
for i in range(len(mse_array)):
    if mse_array[i] < 10:
        nw.append(mse_array[i])
